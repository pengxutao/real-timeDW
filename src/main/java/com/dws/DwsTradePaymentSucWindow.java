...
import com.bean.TradePaymentBean;
import com.utils.DateFormatUtil;
import com.utils.MyClickHouseUtil;
import com.utils.MyKafkaUtil;
import com.utils.TimestampLtz3CompareUtil;
...
public class DwsTradePaymentSucWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 8.提取独立支付成功用户数
        SingleOutputStreamOperator<TradePaymentBean> tradePaymentDS = keyedByUidDS.flatMap(new RichFlatMapFunction<JSONObject, TradePaymentBean>() {
        ...
        //TODO 9.开窗、聚合
        SingleOutputStreamOperator<TradePaymentBean> resultDS = tradePaymentDS.windowAll(TumblingEventTimeWindows.of(Time.seconds(10)))
